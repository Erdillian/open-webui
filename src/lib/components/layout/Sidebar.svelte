<script lang="ts">
	...
	const DEFAULT_PINNED_ITEMS = ['notes', 'workspace', 'memory', 'profile', 'conflicts', 'audit'];
	...
	const getMenuItemMeta = (id) => {
		const items = {
			...
			profile: { label: 'Profil', href: '/profile', iconType: 'profile' },
			conflicts: { label: 'Conflits', href: '/conflicts', iconType: 'conflicts' },
			audit: { label: 'Audit', href: '/audit', iconType: 'audit' }
		};
		return items[id];
	};
